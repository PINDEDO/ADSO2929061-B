...
<div class="flex items-center justify-center min-h-[80vh]">
    <section class="bg-[#000a] p-8 border-white border-2 rounded-xl w-80 flex flex-col justify-center items-center backdrop-blur-sm shadow-2xl">
        <img src="{{ asset('images/loginlarapets.png') }}" alt="Logo" class="w-48 h-48 object-cover rounded-full border-2 border-white mb-4 shadow-lg">
